...
public class CreateCompositeTable implements ProductTable{
	...
	final String Lole[] = {"Micro-Structure＼Class","Composite","Component","Leaf"};
	String[][] TableData = {
			{" "," ","〇","〇"},
			{"〇","　","　","　"},
			{"　","　","〇","　"}, //　後で直せ
	...
	public CreateCompositeTable(Composite container,TabFolder tabfolder) {
